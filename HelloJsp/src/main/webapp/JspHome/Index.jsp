...
<head>
	...
	--------------------------------------------------------------------------%>
	<link rel="stylesheet" href="Index.css?version=1.1"/>
	<style type="text/css">
		/* -----------------------------------------------------------------
			HTML Page 스타일시트
		   ----------------------------------------------------------------- */
...
<%
	...
	// [JSP 지역 변수 선언 : 일반 변수]
	// ---------------------------------------------------------------------
	String sMenuPage1 = "Sawon/SawonList_Rs.jsp?JobProcess=false&jobstatus=SELECT";
	String sMenuPage2 = "Sawon/SawonList_Ar.jsp?JobProcess=false&jobstatus=SELECT";
	String sMenuPage3 = "#";
	String sMenuPage4 = "#";
	String sMenuPage5 = "#";
	// ---------------------------------------------------------------------
...
<body class="Body">
	...
	<form name="form1" action="" method="post">
		...
		----------------------------------------------------------------------%>
		<ul class="Menu">
			<li class="MenuItem"><a class="Link" href="<%=sMenuPage1 %>">사원검색 페이지 (ResultSet)</a></li>
			<li class="MenuItem"><a class="Link" href="<%=sMenuPage2 %>">사원검색 페이지 (ArrayList)</a></li>
			<li class="MenuItem"><a class="Link" href="<%=sMenuPage3 %>">임시 #1 페이지</a></li>
			<li class="MenuItem"><a class="Link" href="<%=sMenuPage4 %>">임시 #2 페이지</a></li>
			<li class="MenuItem"><a class="Link" href="<%=sMenuPage5 %>">임시 #3 페이지</a></li>
		</ul>
		<hr class="Line">
	</form>
	<%----------------------------------------------------------------------
